        ...
        regionOption: {
          ...
          column: [
            ...
            },
            {
              ...
              prop: "regionLevel",
              type: "radio",
              dicUrl: "/api/beletech-system/dict/dictionary?code=region",
              props: {
                label: "dictValue",
                value: "dictKey"
              },
          ...
          column: [
            {
              ...
              action: "/api/beletech-system/region/import-region"
            },
            {
              label: "数据覆盖",
              prop: "isCovered",
          ...
          column: [
            {
              ...
              dicUrl: '/api/beletech-system/region/select',
              span: 24,
            },
            {
              label: '地市',
              ...
              dicFlag: false,
              dicUrl: '/api/beletech-system/region/select?code={{key}}',
              span: 24,
            },
            {
              label: '区县',
    ...
    watch: {
      ...
      'excelForm.isCovered'() {
        if (this.excelForm.isCovered !== '') {
          ...
          column.action = `/api/beletech-system/region/import-region?isCovered=${this.excelForm.isCovered}`;
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      handleExport() {
        this.$confirm("是否导出行政区划数据?", "提示", {
          ...
          window.open(`/api/beletech-system/region/export-region?${this.website.tokenHeader}=${getToken()}`);
        });
      },
      handleTemplate() {
        window.open(`/api/beletech-system/region/export-template?${this.website.tokenHeader}=${getToken()}`);
      },
    }
  };
</script>
